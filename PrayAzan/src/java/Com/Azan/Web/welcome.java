...
{
ImageName="Azan_"+phoneModel.getPhotoSize()+".png";
...
{
CiscoIPPhoneText text=new CiscoIPPhoneText("Azan", "Thank You","Welecome TO STCs Azan IP Phone XML Application" , softkeys);
