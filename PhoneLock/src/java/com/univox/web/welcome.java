...
public class welcome extends HttpServlet {
    ...
    throws ServletException, IOException, Exception {
        ...
        boolean iscolor=IPPhone.isColorPhone(phoneIP);
        ...
        softkeys.add(new SoftKey("Start", "1", LoginPage));

if(phoneModel.isIsColorPhone())
{

ImageName="PhoneLock_"+phoneModel.getPhotoSize()+".png";

Vector menuItems=new Vector();
menuItems.add(new GraphicMenuItem(path,LoginPage,new Point(0, 0),new Point(290, 140)));
CiscoIPPhoneGraphicFileMenu menu=new CiscoIPPhoneGraphicFileMenu("Welcome","Welcome To STCs Lock Service",url+"images/"+ImageName, menuItems, softkeys);
