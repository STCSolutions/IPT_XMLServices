...
public class EmployeOperations extends ConnectionManager
{
    ...
    public ArrayList<String> getUnRegisterdAzanServicePhones()
    {
        ...
        String query = "SELECT distinct p.Extension FROM phone p where p.RigesterForAzan!='false'";
        ResultSet result = getRows( query );
        if ( result != null )
        {
            try
...
////////////////////////////////////////////////////
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println( op.SignOut( "test" ) );
        //System.out.println(op.getAccountPersonalContacts( "amr@univox.com").get( 0).getName());
        //System.out.println(op.SignIn( "test", "1006", "00332255"));
        //System.out.println(op.getUserName( "1006"));
        //System.out.println(op.employeeCheck( "Amr@Univox.com", "123"));

//        try{
//        boolean test= op.add("INSERT INTO `employee` (`ID`,`Name`,`Pin`,`ADUserAcount`,`MobileNumber`,`UserEmail`,`HomeNumber`,`AccountName`) VALUES" +
//                "(20,'Amr Abd El-Monsif Salah','123','Amr@Univox.Com','+20102909291','','','Amr')");
...
//        }
//
//        ResultSet result= op.getRows("select * from myvox.employee");
//        try{
//            while(result.next()){
