...
public class ColumnType  implements java.io.Serializable {
    ...
    /**
     * Gets the name value for this ColumnType.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this ColumnType.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.cisco.com/ast/soap/", "ColumnType"));
